...
- 6.4. 用户不得在设备环境异常的设备上使用本软件，包括但不限于存在检测环境类软件的设备、存在外挂类软件的设备、虚拟机设备，在环境异常的设备上，绀漓丨Sevtinge和/或Re.chronoRain有权拒绝服务；对于明知设备环境存在异常，仍试图逃避并继续使用的，绀漓丨Sevtinge和/或Re.chronoRain对导致的任意问题概不负责
