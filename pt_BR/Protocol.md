O HyperCeiler é desenvolvido e operado pela saraSaku.Hj (Reino Unido) Network Technology Co., Ltd. Ele fornece aprimoramento de funções do sistema HyperOS e outros serviços, e trabalha junto com a estrutura Xposed. Por este meio, pedimos aos usuários que leiam atentamente e compreendam integralmente este Acordo do usuário do HyperCeiler. Os usuários devem ler atentamente e compreender totalmente os termos deste contrato, especialmente os termos que isentam ou limitam a responsabilidade, resolução de disputas e aplicação legal de saraSaku.Hj. Pedimos aos usuários que leiam atentamente e optem por aceitar ou não este contrato (os menores deverão lê-lo acompanhados de um responsável legal). O uso das funções do HyperCeiler pelo usuário será considerado como aceitação deste contrato e concordância em ficar vinculado aos termos deste contrato. Caso o usuário não concorde com este contrato, não utilize nenhuma função do HyperCeiler. saraSaku.Hj tem o direito de alterar este contrato. Os termos atualizados do contrato serão publicados no site oficial e entrarão em vigor a partir da data de vigência da declaração revisada do contrato.
...
## 1. Princípios gerais
- 1.1. O HyperCeiler é uma ferramenta de aprimoramento do sistema HyperOS executada com base na estrutura Xposed. Ela sequestrará seu software e alterará suas funções.
...
- 2.4. Exceto conforme expressamente autorizado por este contrato, saraSaku.Hj não autoriza outros direitos ao usuário. Se o usuário precisar usar outros direitos, ele deverá obter o consentimento por escrito de saraSaku.Hj.
...
- 6.1. Os usuários podem usar o software e os serviços de acordo com este contrato com a premissa de cumprir a lei a este contrato. Os usuários não devem praticar os seguintes atos:
  ...
  - 6.1.6. Usar este software e outros serviços fornecidos por saraSaku.Hj de qualquer forma ilegal, para qualquer finalidade ilegal ou de qualquer forma inconsistente com o uso permitido por este contrato.
- 6.2. Especificações de divulgação de informações:
  ...
  - 6.2.3. Sem a permissão de saraSaku.Hj, os usuários não estão autorizados a realizar quaisquer atividades comerciais neste software, como publicação de anúncios e venda de produtos.
- 6.3. O usuário entende e concorda que:
  - 6.3.1. saraSaku.Hj determinará se o usuário é suspeito de violar os regulamentos de uso acima e, com base no resultado da determinação, suspenderá ou rescindirá a licença de uso do usuário ou tomará outras medidas restritivas que possam ser tomadas de acordo com este contrato.
  - 6.3.2. saraSaku.Hj excluirá diretamente as informações postadas pelos usuários ao usar este software que sejam suspeitas de serem ilegais ou suspeitas de infringir os direitos legais de terceiros ou de violar este contrato.
  - 6.3.3. Se um usuário violar os regulamentos de uso acima e causar danos a terceiros, o usuário deverá assumir a responsabilidade legal de forma independente em seu próprio nome e deverá garantir que saraSaku.Hj esteja protegido contra perdas ou despesas adicionais.
  - 6.3.4. Se o usuário violar disposições legais ou acordos relevantes e fizer com que saraSaku.Hj sofra perdas, ou esteja sujeito a reclamações de terceiros, ou seja punido por autoridades administrativas, o usuário deverá compensar saraSaku.Hj pelas perdas resultantes e despesas. Incluindo, entre outros, honorários advocatícios razoáveis, custos de investigação e coleta de evidências, etc.

## 7. Responsabilidade por quebra de contrato
- 7.1. saraSaku.Hj tem o direito de julgar se o comportamento do usuário está em conformidade com os termos deste contrato. Se acreditar que o usuário violou leis e regulamentos relevantes ou as disposições deste contrato e regras relevantes, saraSaku.Hj tem o direito de tomar medidas contra o usuário com base na gravidade da violação. Excluir informações ilegais, restringir, suspender, encerrar o uso deste serviço de software pelos usuários, exercer as responsabilidades legais dos usuários e outras medidas de processamento que saraSaku.Hj considere apropriadas. Se saraSaku.Hj sofrer quaisquer perdas (incluindo, mas não se limitando ao recebimento de reclamações de terceiros ou penalidades de qualquer departamento administrativo), o usuário assumirá total responsabilidade.

## 8. Riscos de serviço e isenção de responsabilidade
- 8.1. saraSaku.Hj fornece suporte de serviço com tecnologia atual. saraSaku.Hj não garante que a operação deste serviço de software será ininterrupta ou livre de erros, que todos os defeitos neste serviço de software serão corrigidos ou que este serviço de software possa atender a todos os requisitos do usuário. saraSaku.Hj não assume qualquer responsabilidade pelas consequências decorrentes.
- 8.2. saraSaku.Hj não se responsabiliza por quaisquer perdas sofridas pelos usuários devido a terceiros, como falhas nas linhas de comunicação, problemas técnicos, falhas de rede, equipamentos terminais do computador, instabilidade do sistema e outros motivos de força maior.
- 8.3. saraSaku.Hj não garante a legalidade, autenticidade, exatidão e validade do conteúdo das informações obtidas através deste software (incluindo, mas não se limitando ao conteúdo de serviço de terceiros), e saraSaku.Hj não será responsável por quaisquer ações tomadas pelo usuário e não assume nenhuma responsabilidade pelos resultados.
...
- 8.5. Quando o usuário usa o software ou exige que saraSaku.Hj forneça serviços específicos, o software pode chamar um sistema ou software de terceiros para oferecer suporte ao uso ou acesso do usuário. Os resultados do uso ou acesso são fornecidos por terceiro. Além de cumprir as regras relevantes deste contrato, você também deve cumprir os acordos e regras relevantes de terceiros. Os usuários devem compreender e concordar que, ao usar serviços de terceiros, eles podem ler os dados do usuário. saraSaku.Hj não garante a segurança, precisão e eficácia dos resultados alcançados por meio de sistemas de terceiros ou suporte de software de terceiros, e outros riscos incertos, os usuários devem fazer o julgamento prudente. saraSaku.Hj não assume qualquer responsabilidade por quaisquer disputas e danos decorrentes.
- 8.6. saraSaku.Hj lembra especificamente aos usuários que, a fim de proteger a autonomia da empresa no desenvolvimento e ajuste de negócios, saraSaku.Hj pode modificar ou interromper os serviços a qualquer momento após notificar os usuários de maneira razoável.
- 8.7. A menos que especificado de outra forma por leis e regulamentos, saraSaku.Hj fará o possível para garantir que o software, a tecnologia e as informações envolvidas sejam seguras, eficazes, precisas e confiáveis. No entanto, devido às limitações da tecnologia existente, os usuários entendem que saraSaku.Hj não pode. Isso é garantido.
- 8.8. Lesões pessoais ou danos econômicos incidentais ou indiretos causados ​​por ou relacionados a qualquer uma das seguintes circunstâncias, incluindo, entre outros, perda de lucros, perda de dados, danos por interrupção de negócios ou outros danos comerciais. A perda será suportada pelo usuário:
  ...
  - 8.8.5. Outras perdas relacionadas ao software não causadas por saraSaku.Hj.
- 8.9. O usuário concorda que saraSaku.Hj tem o direito de suspender, interromper ou encerrar todos ou parte dos serviços prestados ao usuário com base nas exigências de autoridades judiciais, reguladoras, agências de supervisão ou em seus próprios motivos comerciais. saraSaku.Hj não assume qualquer responsabilidade por isso.
- 8.10. O usuário entende e concorda que saraSaku.Hj não é responsável pela exclusão ou armazenamento ou falha de backup de dados no serviço.
- 8.11. O usuário será o único responsável por quaisquer reclamações, danos ou perdas incorridas por terceiros devido ao upload e compartilhamento de informações de imagem/texto/vídeo pelo usuário. Não tem nada a ver com saraSaku.Hj e saraSaku. saraSaku.Hj não assume qualquer responsabilidade.

## 9. Direitos de propriedade intelectual e declaração de licença de código-fonte aberto
- 9.1. saraSaku.Hj é o proprietário da propriedade intelectual deste software. Todos os direitos autorais, marcas registradas, patentes, segredos comerciais e outros direitos de propriedade intelectual deste software, bem como todas as informações relacionadas a este software (incluindo, entre outros, texto, imagens, áudio, vídeo, gráficos, design de interface, estrutura de layout, dados relacionados, documentos eletrônicos, etc.) são protegidos por leis e regulamentos locais e tratados internacionais correspondentes, e saraSaku.Hj goza dos direitos de propriedade intelectual acima.
- 9.2. Sem o consentimento por escrito de saraSaku.Hj, os usuários não deverão implementar, utilizar ou transferir os direitos de propriedade intelectual acima por si próprio ou permitir que terceiros para qualquer finalidade comercial ou não comercial. saraSaku.Hj reserva-se o direito de prosseguir legalmente responsabilidade pelos atos acima.
- 9.3. Este software é de código aberto baseado em AGPL-3.0, e a localização e o proprietário dos direitos autorais da biblioteca de código-fonte aberto usada devem ser declarados conforme necessário.

## 10. Alterações ao contrato
- 10.1. saraSaku.Hj tem o direito de modificar os termos deste contrato quando necessário. Assim que os termos do contrato mudarem, os termos revisados ​​do contrato serão anunciados na página relevante. Caso não concorde com o conteúdo alterado, o usuário deverá cancelar ativamente este serviço. Se o usuário continuar a utilizar o serviço, considere-se que aceitou as alterações nos termos do contrato.
- 10.2. saraSaku.Hj tem o direito de modificar ou alterar os serviços de cobrança, padrões de cobrança, métodos de cobrança, taxas de serviço e termos de serviço fornecidos, conforme necessário. Quando saraSaku.Hj fornece serviços, ele pode começar a cobrar certas taxas dos usuários de alguns serviços agora ou no futuro. Se os usuários se recusarem a pagar tais taxas, eles não poderão continuar a usar os serviços relevantes após o início da cobrança.
...
- 11.3. O usuário e saraSaku.Hj concordam que todas as disputas decorrentes deste serviço devem ser resolvidas através da negociação. Se a negociação falhar, qualquer uma das partes poderá submeter uma ação judicial a um tribunal com jurisdição sobre o local onde este acordo for assinado.

## 12. Outros
- 12.1. saraSaku.Hj notifica os usuários sobre modificações nos termos de serviço, alterações de serviço e outros assuntos importantes por e-mail ou mensagens de texto ou anúncios na web ou outros métodos considerados apropriados por saraSaku.Hj. Após saraSaku.Hj enviar uma mensagem ao usuário através de qualquer um dos métodos acima, se o usuário não levantar uma objeção por escrito dentro de 3 dias, será considerado que aceitou o conteúdo da nova mensagem.
- 12.2. Este contrato foi atualizado em 1º de outubro de 2023.
